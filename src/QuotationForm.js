...
const QuotationForm = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className="mb-6 p-4 border rounded-lg shadow-md bg-white">
            <h2 className="text-xl mb-4 font-semibold">Quotation Form</h2>
            <div className="mb-4">
            ...
            <div className="mb-4">
                <label className="block mb-1">Quotation Date:</label>
                <input 
                    type="date" 
                    value={quotationDate} 
            ...
            <button type="submit" className="btn bg-blue-500 text-white p-2 rounded hover:bg-blue-600 transition mt-2">Generate Quotation</button>
        </form>
    );
};
